# Epsing — Figma Design Prompt

> **Usage** : colle ce document dans Figma Make / l'IA de design de ton choix.  
> Cursor se chargera de connecter le code généré au backend existant.  
> Tout le wiring API est documenté ici pour que Cursor sache exactement quoi brancher.
